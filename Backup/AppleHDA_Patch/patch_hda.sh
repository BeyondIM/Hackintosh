...
function createAppleHDAInjector()
{
    ...
    ${tools}/zlib deflate /tmp/rm_Platforms.plist > ${resources}/layout/Platforms.xml.zlib
    ${tools}/zlib deflate ${resources}/layout/layout12.plist > ${resources}/layout/layout12.xml.zlib
    cp ${resources}/layout/*.zlib ${injector}/Contents/Resources/
